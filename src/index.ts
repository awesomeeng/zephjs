...
function Zeph(name?: string): any {
	...
	return function(ctor:any) {
		...
		const componentClass:any = class ZephComponent extends ctor {
			constructor() {
				super();
			}
		}
		...
		if (!componentName) throw new Error('Unable to figure our the name for this component. Please provide the name via the @zeph(<name>) argument, or provided a class name.');
